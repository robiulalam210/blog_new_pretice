...
class AuthParasolRepository {
  BaseApiServices apiService = NetworkApiServices();

  Future<OtpSendModel> otpsendApi(body) async {
    try {
      dynamic response = await apiService.postApi(AppUrls.REGISTER_MOBILE_OTP_SEND, body);
      print(response);
      return OtpSendModel.fromJson(response);
    } catch (e) {
      rethrow;
    }
  }
